...
public class SeleniumUtility {
	...
	public void clickAndHoldOpertion(WebDriver driver,WebElement element) {
		Actions act=new Actions(driver);
	...
	public void dragAndDropOpertion(WebDriver driver,WebElement element1,WebElement element2) {
		Actions act=new Actions(driver);
		act.dragAndDrop(element1,element2).perform();
	}
	
	public void dragAndDropByOpertion(WebDriver driver,WebElement element,int xoffset,int yoffset) {
		Actions act=new Actions(driver);
